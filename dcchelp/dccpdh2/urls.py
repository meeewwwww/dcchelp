...
urlpatterns = [
    ...
    path('documentation/article/<int:article_id>/edit/', views.edit_article, name='edit_article'),
    path('documentation/article/<int:article_id>/delete/', views.delete_article, name='delete_article'),
